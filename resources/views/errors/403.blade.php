            ...
            <div class="card-body bg-light">
                ...
                <div class="container">
                    <p class="mb-4 text-muted text-center">
                        <strong>🚫 Oops! Você não tem permissão para estar aqui.</strong></p>
                    <p>
                        Parece que você tentou acessar uma área restrita. Verifique suas credenciais e tente novamente. Se acha que isso é um engano, fale com o suporte. 😉
                    </p>
                </div>
