            ...
            <div class="card-body bg-light">
                ...
                <div class="container">
                    <p class="mb-4 text-muted text-center">
                        <strong>Ops! Parece que estamos com alguns problemas técnicos. Tente novamente mais tarde.</strong></p>
                    <p>
                        Estamos passando por uma manutenção rapidinha 🚧. Por favor, volte em alguns minutos. Agradecemos pela paciência! 🙏
                    </p>
                </div>
