    ...
    <div class="card-body" style="max-width: 600px;">
        <form action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" name="data_nascimento" class="form-control @error('data_nascimento') is-invalid @enderror" id="inputDataNascimento" value="{{ old('data_nascimento', $user->data_nascimento) }}">
                ...
                <div class="mb-3">
                    <label for="inputNomeCompleto" class="form-label"><strong>Nome Completo (legado):</strong></label>
                    <input type="text" name="name" value="{{ old('name', $user->name) }}"
                        class="form-control @error('name') is-invalid @enderror" id="inputNomeCompleto" placeholder="Nome completo...">
                    @error('name')
                        <div class="form-text text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-check mt-4">
                            <input class="form-check-input" type="checkbox" id="celularWhatsapp" name="celular_whatsapp" value="1" {{ old('celular_whatsapp', $user->celular_whatsapp) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="email" name="email_alternativo" class="form-control @error('email_alternativo') is-invalid @enderror" id="inputEmailAlternativo"
                                placeholder="Email Alternativo..." value="{{ old('email_alternativo', $user->email_alternativo) }}">
